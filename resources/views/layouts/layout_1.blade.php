...
<head>
	...
	<link rel="shortcut icon" href="<?= PATH_APP; ?>favicon.ico">
	<link href='http://fonts.googleapis.com/css?family=Lato:300,400,300italic,400italic' rel='stylesheet' type='text/css'>
	<link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
	<!-- Global CSS -->
	<link rel="stylesheet" href="<?= PATH_APP; ?>assets/plugins/bootstrap/css/bootstrap.min.css">
	<!-- Plugins CSS -->
	<link rel="stylesheet" href="<?= PATH_APP; ?>assets/plugins/font-awesome/css/font-awesome.css">
	<!-- github acitivity css -->
	<link rel="stylesheet" href="<?= PATH_APP; ?>assets/plugins/github-activity/dist/github-activity-0.1.1.min.css">
	<link rel="stylesheet" href="<?= PATH_APP; ?>assets/plugins/github-activity/dist/octicons/octicons.min.css">
	<!-- Theme CSS -->
	<link id="theme-style" rel="stylesheet" href="<?= PATH_APP; ?>assets/css/styles.css">
...
<body>
	...
	<header class="header">
		<div class="container">
			<img class="profile-image img-responsive pull-left" src="<?= PATH_APP; ?>assets/images/profile.png" alt="James Lee" />
	...
	<div class="container sections-wrapper">
		<div class="row">
				<div class="primary col-md-8 col-sm-12 col-xs-12">
					...
					<section class="about section">
						<div class="section-inner">
							<h2 class="heading">@yield("title_content")</h2>
							<div class="content">
								<div class="row">
						...
						<div class="section-inner">
							...
							<div class="content">
								<ul class="list-unstyled">
									<li><a href="/assets/themes/basic/index.html" target="_blank">View template</a></li>
								</ul>
							</div><!--//content-->
						</div><!--//section-inner-->
					</aside><!--//aside-->
			...
			<!-- Javascript -->
			<script type="text/javascript" src="<?= PATH_APP; ?>assets/plugins/jquery-1.11.2.min.js"></script>
			<script type="text/javascript" src="<?= PATH_APP; ?>assets/plugins/jquery-migrate-1.2.1.min.js"></script>
			<script type="text/javascript" src="<?= PATH_APP; ?>assets/plugins/bootstrap/js/bootstrap.min.js"></script>
			<!-- custom js -->
			<script type="text/javascript" src="<?= PATH_APP; ?>assets/js/main.js"></script>
		</body>
		</html>